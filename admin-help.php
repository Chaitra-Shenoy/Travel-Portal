...
<body>
  ...
  <div class="container">
    <h2 class="text-help">Complaints Recieved</h2>
    <form action="admin-help-resolved.php" method="post" class="text-center" id="form">
        <label for="info">Complain Id</label>
        <br>
        <input type="text" name="id" id="id" class="text-center">
            ...
            if(mysqli_num_rows($result) > 0)
            {
                while($row = mysqli_fetch_array($result))
                {
                    echo "<tr>";
                        ...
                        echo "<td width=15%>" . $row['contact'] . "</td>";
                        echo "<td width=10%>" . $row['problem'] . "</td>";
...
?>
    ...
    <a href="logout.php" type="submit" class="btn btn-primary next-button text-center" name="Submit1" style="margin-left:450px;">Logout</a>
</div>
</div>
  </div>
</div>
