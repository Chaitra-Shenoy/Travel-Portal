<!DOCTYPE html>
<html lang="en">
<title>Admin-Flight-Confirmation</title>
<head>
    <meta charset="UTF-8">
...
?>
    <div class="container text-center" style="margin-top:150px; margin-bottom:50px;">
        <h3 style="margin-top:200px;">FLIGHT No. 
            <?php 
            if(empty($_SESSION['flight_code']) || !empty($_SESSION['emp_id']))
            {
        ...
        <a href="admin-flights.php" class="btn btn-primary button" style="margin-top: 20px; margin-bottom:20px;">Back</a>
        <a href="logout.php" class="btn btn-primary button" style="margin-top: 20px; margin-bottom:20px;">Logout</a>
    </div>
