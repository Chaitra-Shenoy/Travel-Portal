...
<body>
    ...
    <div class="container text-center" style="margin-top:25px; margin-bottom:25px">
        ...
        <form action="admin-login.php" method="post">
            ...
            <br>
            <input type="text" name="admin_id" id="admin_id" style="margin-bottom:10px; margin-top:10px;">
            <br>
    
            <label for="info" style="margin-bottom:10px;">Enter the employee password</label>
            <br>
            <input type="password" name="admin_pass" id="admin_pass" style="margin-bottom:10px; margin-top:10px;">
            <br>
            <form action="admin-login.php" method="post" >
