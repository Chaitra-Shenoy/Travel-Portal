...
<body>
    ...
    <div class="container text-center" style="margin-top:15px; margin-bottom:15px;">
        ...
        <form action="admin-flights.php" method="post">
            ...
            <br>
            <input type="text" name="a_code" id="a_code" style="margin-top:5px; margin-bottom:5px;">
            <br>

            <label for="info" style="margin-bottom:10px">Enter the flight code</label>
            <br>
            <input type="text" id="flight_code" name="flight_code" style="margin-top:5px; margin-bottom:5px;">
            <br>

            <label for="info" style="margin-bottom:10px">Enter the starting point of travel</label>
            <br>
            <input type="text" id="from_source" name="from_source" style="margin-top:5px; margin-bottom:5px;">
            <br>

            <label for="info" style="margin-bottom:10px">Enter the destination</label>
            <br>
            <input type="text" id="to_dest" name="to_dest" style="margin-top:5px; margin-bottom:5px;">
            <br>

            <label for="info" style="margin-bottom:10px">Enter the time of departure</label>
            <br>
            <input type="text" id="departure_time" name="departure_time" style="margin-top:5px; margin-bottom:5px;">
            <br>

            <label for="info" style="margin-bottom:10px">Enter the time of arrival</label>
            <br>
            <input type="text" id="arrival_time" name="arrival_time" style="margin-top:5px; margin-bottom:5px;">
            <br>

            <label for="info" style="margin-bottom:10px">Enter the no. of seats available</label>
            <br>
            <input type="text" id="seats_available" name="seats_available" style="margin-top:5px; margin-bottom:5px;">
            <br>

            <label for="info" style="margin-bottom:10px">Enter the date of flight</label>
            <br>
            <input type="text" id="date_of_flight" name="date_of_flight" style="margin-top:5px; margin-bottom:5px;">
            <br>
            
            <form action="admin-login.php" method="post" >
                     <button type="submit" class="btn btn-primary next-button" style="margin-bottom:15px" name="Submit1">Next</button>
            </form>
            <br>
