...
<?php
        ...
        if(!empty($emp_id))
        {
            if(isset($_POST['Submit1'])) 
            {
               ...
               $q="insert into flight_info(a_code,flight_code,from_source,to_dest,departure_time,arrival_time,seats_available,date_of_flight,price) values ('$a_code','$flight_code','$from_source','$to_dest','$departure_time','$arrival_time','$seats_available','$date_of_flight','$price')";
    ...
    <div class="container text-center" style="margin-top:15px; margin-bottom:15px;">
        ...
        <form action="admin-flights.php" method="post">
            ...
            <label for="info" style="margin-bottom:10px">Enter the price for one ticket</label>
            <br>
            <input type="text" id="price" name="price" style="margin-top:5px; margin-bottom:5px;" required>
            <br>
            <button type="submit" class="btn btn-primary next-button" name="Submit1" id="Submit1" style="margin-right:20px;">Next</button>
