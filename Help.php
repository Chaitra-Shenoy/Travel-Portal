                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="Help.php" method="POST">
                            ...
                            <div class="form-group">
                                <label for="info">Problem faced: </label>
                                <textarea id="prob" name="prob" rows="3" cols="50" class="form-control"></textarea>
                            </div>
...
S
    ...
    if (isset($_POST['submit1'])) 
    {
        $con = mysqli_connect("localhost:3306","root","","travels");
            ...
            $pnum=$_POST['pno'];
            $prob = $_POST['prob'];
            $sql1="insert into help(email,fname,lname,contact,problem,status) values ('$email1','$fname1','$lname1','$pnum','$prob','Not Resolved')";
