<!DOCTYPE html>
<html lang="en">
<title>Admin-Login-Help-Committee</title>
<head>
    <meta charset="UTF-8">
...
<style type="text/css">
    ...
    <div class="container text-center" style="margin-top:25px; margin-bottom:25px">
        <h1 style="border-bottom:1px solid black;">ADMIN LOGIN - HELP COMMITTEE</h1>
        <form action="admin-help-login.php" method="post">
    ...
    if(isset($_POST['Submit1'])) 
    {
           ...
           {
                header('Location:Invalid-login-help.html');
           }
