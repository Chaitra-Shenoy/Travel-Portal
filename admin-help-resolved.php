...
?>
    <div class="container text-center" style="margin-top:100px; margin-bottom:50px;">
        <h1 style="margin-top:175px;">Complain with Complain id <?php echo $_POST['id'];?> is resolved.</h1>
        <a href="admin-help-login.php" class="btn btn-primary button" style="margin-top: 20px; margin-bottom:20px;">Back To LOGIN PAGE</a>
    </div>
