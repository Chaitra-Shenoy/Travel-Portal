<!DOCTYPE html>
<html lang="en">
<title>Flight Unavailable</title>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="container text-center" style="margin-top:50px; margin-bottom:50px;">
        <h1 style="margin-top:100px;">Flight unavailable from <?php echo strtoupper($s);?> to <?php echo strtoupper($d);?></h1>
        <a href="NextBooking.html" class="btn btn-primary button" style="margin-top: 20px; margin-bottom:20px;">Back To BOOKING</a>
    </div>
